        ...
        <View style={{ width: '100%' }}>
                ...
                render={({ field: { onChange, value } }) => (
                    <View style={{ marginBottom: SPACING.large }}>
                        <View style={styles.inputWrapper}>
                            <Ionicons name="call" size={20} color={COLORS.primary} style={{ marginRight: SPACING.medium }} />
                            <TextInput
                                style={styles.input}
                                placeholder="请输入手机号"
            ...
            <Controller
                ...
                render={({ field: { onChange, value } }) => (
                    <View style={{ marginBottom: SPACING.large }}>
                        <View style={styles.inputWrapper}>
                            <Ionicons name="lock-closed" size={20} color={COLORS.primary} style={{ marginRight: SPACING.medium }} />
                            <TextInput
                                style={styles.input}
                                placeholder="请输入验证码"
                                placeholderTextColor={COLORS.textSecondary}
