...
export const SCENARIO_TEMPLATES: Record<ScenarioType, ScenarioTemplate> = {
    travel: {
        ...
        fields: [
            { id: 'location', label: '目的地', type: 'location', required: true, placeholder: '添加旅行地点' },
            { id: 'companions', label: '同行人', type: 'people', required: false, placeholder: '和谁一起？' },
            { id: 'highlights', label: '亮点', type: 'text', required: false, placeholder: '最难忘的瞬间' },
    ...
    food: {
        ...
        fields: [
            { id: 'foodName', label: '美食名称', type: 'text', required: true, placeholder: '吃了什么？' },
    ...
    daily: {
        ...
        fields: [
            { id: 'content', label: '今日记录', type: 'text', required: true, placeholder: '记录今天的故事' },
    ...
    special: {
        ...
        fields: [
            ...
            { id: 'occasion', label: '场合', type: 'text', required: false, placeholder: '生日/纪念日/节日...' },
            { id: 'companions', label: '同行人', type: 'people', required: false, placeholder: '和谁一起？' },
            { id: 'story', label: '故事', type: 'text', required: false, placeholder: '记录这个特别时刻' },
            { id: 'photos', label: '照片', type: 'image', required: false },
            { id: 'tags', label: '标签', type: 'tags', required: false },
        ],
    },
