...
const DiaryDetailScreen: React.FC = () => {
    ...
    console.log('[DiaryDetail] diary data:', diary);
    console.log('[DiaryDetail] scenario:', diary.scenario, 'template:', SCENARIO_TEMPLATES[diary.scenario]);
    console.log('[DiaryDetail] mood:', diary.mood, 'config:', MOOD_CONFIG[diary.mood]);
    console.log('[DiaryDetail] weather:', diary.weather, 'config:', WEATHER_CONFIG[diary.weather]);
    ...
    if (!scenario || !mood || !weather) {
        console.error('[DiaryDetail] Invalid data - scenario:', !!scenario, 'mood:', !!mood, 'weather:', !!weather);
        return (
            <View style={styles.errorContainer}>
